            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <!-- Messages                        -->
                    <li class="nav-item dropdown"><a id="messages" rel="nofollow" data-target="#" href="#"
                                ...
                                class="badge bg-orange badge-corner">{{ \App\Contact::where('read', 1)->count() }}</span></a>
                        <ul aria-labelledby="notifications" class="dropdown-menu">
                            ...
                            <li>
                                <a rel="nofollow" href="{{ route('contact.index', app()->getLocale() ) }}"
                                   class="dropdown-item all-notifications text-center">
                                    <strong>{{ \App\Attribute::first()->translate(app()->getLocale())->read_all  }}</strong></a>
                            </li>
                        </ul>
                    </li>
                    <!-- Languages dropdown    -->
        ...
        <ul class="list-unstyled">
            <li class="{{ (request()->is('admin/' . app()->getLocale() )) ? 'active' : '' }}"><a
                    href="{{ route('dashboard', app()->getLocale() ) }}"> <i
                        class="icon-home"></i>{{ \App\Attribute::first()->translate(app()->getLocale())->admin_nav_item_home  }}
                </a></li>
            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/attribute*')) ? 'active' : '' }}"><a
                    href="{{ route('attribute.index', app()->getLocale() ) }}"> <i
                        class="icon-screen"></i>{{ \App\Attribute::first()->translate(app()->getLocale())->admin_nav_item_mainAttributes  }}
                </a>
            </li>
            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/category*')) ? 'active' : '' }}
            {{(request()->is('admin/'. app()->getLocale() .'/sub-category*')) ? 'active' : ''}}">
                <a
                    href="{{ route('category.index', app()->getLocale() ) }}"> <i
                        class="icon-interface-windows"></i>{{ \App\Attribute::first()->translate(app()->getLocale())->admin_nav_item_streams  }}
                </a>
            </li>
{{--            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/product*')) ? 'active' : '' }}"><a--}}
{{--                    href="{{ route('product.index', app()->getLocale() ) }}"> <i--}}
{{--                        class="icon-interface-windows"></i>{{ \App\Attribute::first()->translate(app()->getLocale())->admin_nav_item_products  }}--}}
{{--                </a>--}}
{{--            </li>--}}
            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/contact*')) ? 'active' : '' }} "><a
                    href="{{ route('contact.index', app()->getLocale() ) }}"> <i
                        class="icon-mail"></i>{{ \App\Attribute::first()->translate(app()->getLocale())->admin_nav_item_messages  }}
                </a>
            </li>
